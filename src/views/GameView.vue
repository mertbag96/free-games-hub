...
<template>
    ...
    <PageContainer v-else-if="gameLoaded" class="relative py-8 pb-16 md:py-10 md:pb-18">
        <div
            class="pointer-events-none absolute left-4 top-18 h-64 w-64 rounded-full bg-primary/14 blur-[100px] sm:left-10 md:top-24 lg:left-14"
            aria-hidden="true"
        />
        <div
            class="pointer-events-none absolute bottom-[-5%] right-4 h-72 w-72 rounded-full bg-secondary/12 blur-[110px] sm:right-12"
            aria-hidden="true"
        />
        ...
        <div class="relative">
            ...
            <article class="relative overflow-hidden rounded-4xl border border-secondary/35 bg-secondary text-white shadow-[0_42px_100px_-40px_rgb(0_53_86/0.55)] ring-1 ring-white/10 md:rounded-[2.25rem]">
                <div class="pointer-events-none absolute inset-0 opacity-[0.5]" aria-hidden="true">
                    ...
                    />
                    <div
                        class="absolute inset-0 opacity-[0.03] bg-[linear-gradient(rgb(255_255_255/0.6)_1px,transparent_1px),linear-gradient(90deg,rgb(255_255_255/0.6)_1px,transparent_1px)] [bg-size:24px_24px]"
                    />
                </div>
                ...
                >
                    ...
                    <div class="min-w-0 space-y-5 md:space-y-6">
                        <div class="flex flex-wrap items-center gap-2 lg:hidden">
                            ...
                            <Badge v-if="state.game.status" variant="muted" class="border-0! bg-white/12! text-white!">
                                {{ state.game.status }}
                            </Badge>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-3 pt-2">
                            <Link
                                ...
                                class="inline-flex min-h-12 min-w-44 items-center justify-center gap-2 rounded-xl bg-primary px-7 text-[0.9375rem] font-bold uppercase tracking-[0.08em] text-white shadow-[0_22px_40px_-16px_rgb(239_76_79/0.55)] outline-none ring-2 ring-transparent transition-[transform,box-shadow] hover:-translate-y-0.5 hover:bg-primary hover:shadow-[0_28px_50px_-16px_rgb(239_76_79/0.55)] hover:shadow-primary/55 focus-visible:ring-white/95"
                ...
                <dl
                    ...
                    class="relative grid grid-cols-1 gap-px bg-white/12 p-px sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6"
                >
                    <div
            ...
            <div v-if="specRows.length" class="relative mt-8 md:mt-10">
                <div class="rounded-2xl border border-secondary/22 bg-secondary/4 px-6 py-6 shadow-inner shadow-secondary/6 backdrop-blur-sm md:p-8">
                    <div class="relative">
                        <p class="font-mono text-[0.65rem] font-bold uppercase tracking-[0.2em] text-primary">
                    ...
                    >
                        <div
                            ...
                            :key="label"
                            class="grid gap-3 px-4 py-4 sm:grid-cols-[minmax(8rem,10rem)_1fr] sm:items-start sm:gap-6 md:px-5 md:py-4.25"
                        >
                            <span
